            ...
            <ul className="navbar-nav">
              ...
              {appearanceFields.showStationary === true && (
                <li className="nav-item">
                  <Link
                    ...
                    style={{
                      background:
                        activePage === "/alo24/statsionar" ? "#F97316" : "",
                    }}
                  >
                    <i className="icon-devices_other nav-icon" />
                    {t("Statsionar")}
              ...
              <li className="nav-item">
                <Link
                  ...
                  style={{
                    background:
                      activePage === "/alo24/discount" ? "#F97316" : "",
                  }}
                >
                  <i className="icon-devices_other nav-icon" />
                  {t("Chegirmalar")}
              ...
              <li className="nav-item">
                <Link
                  ...
                  to="/alo24/debt"
                  style={{
                    background: activePage === "/alo24/debt" ? "#F97316" : "",
                  }}
                >
                  <i className="icon-devices_other nav-icon" />
                  {t("Qarzlar")}
              ...
              <li className="nav-item">
                <Link
                  className={`nav-link ${
                    activePage === "/alo24/expense" ? "active-page" : ""
                  }`}
                  onClick={() => {
                  ...
                  style={{
                    background:
                      activePage === "/alo24/expense" ? "#F97316" : "",
                  }}
                >
                  <i className="icon-devices_other nav-icon" />
                  {t("Xarajatlar")}
