            ...
            <div className="flex items-start w-full">
              <div className="flex flex-wrap w-[50%]">
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  ...
                  <input
                    ...
                    style={{
                      color: "#999",
                      border: client.born && "1px solid blue",
                    }}
                    value={clientDate}
                  />
                </div>
                ...
                <div className="col-sm-6 col-12">
                  ...
                  <input
                    value={
                      room?.beginday &&
                      new Date(room?.beginday).toISOString().slice(0, 10)
                    }
                    onChange={(e) =>
                      setRoom({ ...room, beginday: new Date(e.target.value) })
                    }
                    type="date"
                    className="form-control inp"
                    placeholder=""
                    style={{
                      color: "#999",
                      border: room.beginday && "1px solid blue",
                    }}
                  />
                </div>
                <div className="col-sm-6 col-12">
                  <label htmlFor="biO">
                    {t("Qabulxonada quyilgan tashxis")}
                  </label>
                  <textarea
              ...
              <div className="flex flex-wrap w-[50%]">
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      name="medicineresult"
                      style={{
                        border: client.medicineresult && "1px solid blue",
                      }}
                    />
                  </div>
                </div>
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div className="form-group">
                    <label htmlFor="inputEmail">
                      {t("Qarindoshlarning tel raqami va yashash joyi")}
                    </label>
                    <input
                      ...
                      name="relative_info"
                      style={{
                        border: client.relative_info && "1px solid blue",
                      }}
                    />
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      style={{
                        border: client.profession_info && "1px solid blue",
                      }}
                    />
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      name="sending_info"
                      style={{
                        border: client.sending_info && "1px solid blue",
                      }}
                    />
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div className="form-group">
                    <label htmlFor="inputEmail">
                      {t("Kasalxonaga shoshilinch ravishda keltirilganmi?")}
                    </label>
                    <input
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      style={{
                        border: client.ambulance_transport && "1px solid blue",
                      }}
                    />
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div className="form-group">
                    <label htmlFor="inputEmail">
                      {t("Kasallik boshlangandan so'ng utgan vaqt")}
                    </label>
                    <input
                      ...
                      name="start_sickness"
                      style={{
                        border: client.start_sickness && "1px solid blue",
                      }}
                    />
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      style={{
                        border: client.conter_diagnosis && "1px solid blue",
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="">
                ...
                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div className="text-right">
                    {loading ? (
                      <button
                        className="bg-alotrade text-white rounded py-2 px-3"
                        disabled
                      >
                        <span className="spinner-border spinner-border-sm"></span>
                        Loading...
