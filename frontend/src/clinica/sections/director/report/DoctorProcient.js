    ...
    <div className="bg-slate-100 content-wrapper px-lg-5 px-3">
      ...
      <div className="row gutters">
        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          {auth?.clinica?.mainclinica && auth?.clinica?.filials.length > 0 && (
                            ...
                            {loading ? (
                              ...
                              <button
                                onClick={() => {
                                  if (type === "offline") {
                                    history.push(
                                      "/alo24/doctor_procient_services",
                                      {
                                        doctor,
                                        startDate: beginDay,
                                        endDate: endDay,
                                    ...
                                    history.push(
                                      "/alo24/doctor_procient_statsionar",
                                      {
                                        doctor,
                                        startDate: beginDay,
                                        endDate: endDay,
