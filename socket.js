...
const {getDepartments, getDepartmentsOnline} = require("./routers/offlineclient/clients.route");
...
const initializeSocket = (server) => {
    ...
    io.on('connection', (socket) => {
        socket.on('getDepartments', async (data) => {
            ...
            try {
                const departments = await getDepartments(clinicaId, departments_ids, next, clientId);
